...
func (ctrl *cUcSystemMaster) HandleLogin(c *gin.Context) {
	...
	// 写入用户登入记录
	_ = system.WriteSystemMasterVisitorLogs(c, 1, 1, 0, "管理员登入")
...
func (ctrl *cUcSystemMaster) HandleChangeOwnPassword(c *gin.Context) {
	...
	// 写入修改自己的密码操作记录
	_ = system.WriteSystemMasterVisitorLogs(c, 1, 2, 0, "修改自己的密码")
	return
}
...
func (ctrl *cUcSystemMaster) Logout(c *gin.Context) {
	// 写入退出登录操作记录
	_ = system.WriteSystemMasterVisitorLogs(c, 1, 1, 0, "退出登录")
	system.DeleteSession(c, "ice_flame_master")
...
func (ctrl *cUcSystemMaster) HandleChangeMasterInfo(c *gin.Context) {
	...
	// 写入修改管理员自己的信息操作记录
	_ = system.WriteSystemMasterVisitorLogs(c, 1, 2, 0, "修改管理员自己的信息")
	return
}
...
func (ctrl *cUcSystemMaster) HandleCreateSystemMaster(c *gin.Context) {
	...
	if err := c.ShouldBind(&form); err != nil {
		...
		// 写入添加管理员信息操作记录
		_ = system.WriteSystemMasterVisitorLogs(c, 1, 2, 0, "添加管理员信息")
	}
...
func (ctrl *cUcSystemMaster) HandleAjaxEditMaster(c *gin.Context) {
	...
	// 写入编辑管理员信息操作记录
	_ = system.WriteSystemMasterVisitorLogs(c, 1, 2, 0, "编辑管理员信息")
