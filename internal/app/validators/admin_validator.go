...
type AdminRoleRelation struct {
	AccountID uint32 `form:"account_id" binding:"required,positive_int" msg:"管理员名称不能为空|管理员ID信息错误"`
	RoleID    uint32 `form:"role_id" binding:"required,positive_int" msg:"角色名称不能为空|角色ID信息错误"`
}
